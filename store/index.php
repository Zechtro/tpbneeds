        ...
        <div id="lower-header">
            ...
            <nav id="icon-links">
                <ul>
                    ...
                    <li><a class="user-only-link" href="../user/topup.php"><i class="fa-solid fa-money-bill user-only-link"></i></a></li>
                </ul>
            </nav>
        </div>
    </header>
