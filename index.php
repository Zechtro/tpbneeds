    ...
    <main>
        <section class="carousel">
            <div class="carousel-container">
                <div class="slide fade" style="background-image:url(images/math_bg.png); background-size: 100% 100%;">
                    <div class="slide-text">
                        <p class="carousel__populer">Populer</p>
                        <p class="carousel__buku">Kalkulus Jilid 1</p>
                        <p class="carousel__toko">Ganesha Goods</p>
                        <p class="carousel__deskripsi">The first edition of Calculus is again a modest revision. Some topics have been added, and some of the topics have been rearranged, but the spirit of the book has remained unchanged. Users of previous editions have reported success, and we have no intention of overhauling a warkable text.</p>
                    </div>
                ...
                <div class="slide fade" style="background-image:url(images/phys_bg.png); background-size: 100% 100%;">
                    <div class="slide-text">
                        <p class="carousel__populer">Populer</p>
                        <p class="carousel__buku">Halliday Jilid 1</p>
                        <p class="carousel__toko">Rasio</p>
                        <p class="carousel__deskripsi">Diterbitkan pertama kali pada tahun 1960, buku Fisika Dasar karya Halliday-Resnick-Walker ini adalah salah satu buku Fisika Dasar yang paling banyak dipakai di seluruh dunia. Buku ini telah diterjemahkan ke 40 bahasa. Di Indonesia sendiri, buku Fisika Dasar karya Halliday ini....</p>
                    </div>
                    <section class="masukkan-beli">
                        <button class="btn-masukkan">
                            <p>Masukkan Keranjang</p>
                    ...
                    <img class="carousel-img" src="images/product/halliday_1.jpg">
                </div>
                <div class="slide fade" style="background-image:url(images/chem_bg.png); background-size: 100% 100%;">
                    <div class="slide-text">
                        <p class="carousel__populer">Populer</p>
                        <p class="carousel__buku">Chemistry Brady 7th Edition</p>
                        <p class="carousel__toko">Rasio</p>
                        <p class="carousel__deskripsi">Chemistry, Seventh Edition provides the necessary practice, support, concept mastery and individualized instruction that ensure success in the General Chemistry course. The unique "chemical tools" approach employed in this book provides a way of thinking that helps readers develop the ability to analyze and solve both mathematical and conceptual problems.</p>
                    </div>
                    <section class="masukkan-beli">
                        <button class="btn-masukkan">
                            <p>Masukkan Keranjang</p>
                    ...
                    <img class="carousel-img" src="images/product/brady_1.jpg">
                </div>
            </div>
        </section>
